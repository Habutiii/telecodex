...
export class OpenAICodexSessionService {
  ...
  static async create(config: TeleCodexConfig, options?: CreateOptions): Promise<OpenAICodexSessionService> {
    const service = new OpenAICodexSessionService(config);
